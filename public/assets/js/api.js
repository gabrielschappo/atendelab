window.AtendeLabApi = (() => {
    ...
    function escapeAttr(value) { return escape(value).replace(/\n/g, '&#096;'); }
    ...
    return {
        get: (controller, action, query = {}) => request(controller, action, 'GET', query),
        post: (controller, action, body = {}) => request(controller, action, 'POST', {}, body),
        toList,
        toObject,
        escape,
        escapeAttr,
